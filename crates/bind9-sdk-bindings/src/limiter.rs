...
/// A concurrency limiter for rndc operations.
///
...
#[napi]
pub struct JsRndcLimiter {
    inner: RndcLimiter,
}

#[napi]
impl JsRndcLimiter {
    /// Create a new rndc concurrency limiter.
    ///
    ...
    pub fn new(
        ...
        let limiter = RndcLimiter::new(config, max_concurrent as usize);
    ...
    /// Execute an rndc command through the limiter.
    ///
